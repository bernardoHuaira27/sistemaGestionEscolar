...
<?php 
    ...
    try {
        $sql = 'SELECT * FROM usuarios as u INNER JOIN rol as r ON u.rol = r.rol_id WHERE u.estado != 3';
        ...
        for ($i = 0; $i < count($consulta); $i++){
            ...
            $consulta[$i]['acciones'] = '
                ...
                <button class="btn btn-danger" title="Editar" onclick="eliminarUsuario('.$consulta[$i]['usuario_id'].')">Eliminar</button>
            ';
        }
